...
public class NetworkTask_Subscribe_Insert_Update extends AsyncTask<Integer, String, Void> {
    ...
    public NetworkTask_Subscribe_Insert_Update(Context context, String mAddr) {
