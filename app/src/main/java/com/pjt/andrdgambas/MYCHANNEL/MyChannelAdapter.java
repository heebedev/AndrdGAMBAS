...
//            });
            ...
            llPrdList = itemView.findViewById(R.id.Ll_prdList);
    ...
    public void onBindViewHolder(final MyChannelAdapter.ViewHolder holder, final int position) {
        ...
        holder.llPrdList.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                STATICDATA.PRD_SEQNO = mData.get(position).getProductSeqno();
                Log.v("PrdSeqno", String.valueOf(STATICDATA.PRD_SEQNO));
                Intent intent = new Intent(view.getContext(), ContentListActivity.class); // ContentsList로이
