...
import com.pjt.andrdgambas.HOME.HomeAdapter;
...
public class Activity_Mychannel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update = findViewById(R.id.btn_mych_update);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.btn_mych_update:
                    intent = new Intent(Activity_Mychannel.this, Activity_Mychannel.class);
